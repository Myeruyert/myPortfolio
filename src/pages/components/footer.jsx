...
const Footer = () => {
  return (
    <>
      <div className="m-auto foot py-24">
        ...
        <div className="mb-12">
          <div className="mail flex items-center mb-4">
            ...
            <span className="text-4xl mx-5 font-semibold text-gray-900">tom@pinecone.mn</span>
            <BsCopy className="text-3xl" />
          </div>
          <div className="phone flex items-center">
          <IoCallOutline className="text-3xl" />
            <span className="text-4xl mx-5 font-semibold text-gray-900">+ 976 88112233</span>
            <BsCopy className="text-3xl" />
          </div>
        </div>
        <div className="mb-2">
